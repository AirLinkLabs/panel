...
const module: Module = {
  ...
  router: () => {
    ...
    router.get(
      ...
      async (req, res, next) => {
        try {
          const data = await apiGet(req, "/api/v2/admin/queue");
          res.json(data);
        } catch (err) {
          next(err);
        }
      ...
      async (req, res, next) => {
        try {
          const result = await apiPost(
            req,
            `/api/v2/admin/queue/${req.params.serverId}/kick`,
            req.body,
          );
          res.json(result);
        } catch (err) {
    ...
    router.post(
      ...
      async (req, res, next) => {
        try {
          const result = await apiPost(
            req,
            `/api/v2/admin/queue/users/${req.params.userId}/ban`,
            req.body,
          );
          res.json(result);
        } catch (err) {
    ...
    router.post(
      ...
      async (req, res, next) => {
        try {
          const result = await apiPost(
            req,
            `/api/v2/admin/queue/users/${req.params.userId}/unban`,
            req.body,
          );
          res.json(result);
        } catch (err) {
