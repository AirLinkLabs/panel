...
const module: Module = {
  ...
  router: () => {
    ...
    router.get(
      ...
      async (req, res, next) => {
        try {
          const data: any = await apiGet(req, '/api/v2/admin/security/2fa');
    ...
    router.get(
      ...
      async (req, res, next) => {
        try {
          const data: any = await apiGet(req, '/api/v2/admin/security/captcha');
      ...
      async (req, res, next) => {
        try {
          const data: any = await apiGet(
            req,
            '/api/v2/admin/security/api-access',
          );
    ...
    router.get(
      ...
      async (req, res, next) => {
        try {
          const data: any = await apiGet(
            req,
            '/api/v2/admin/security/admin-access',
          );
    ...
    router.get(
      ...
      async (req, res, next) => {
        try {
          const data: any = await apiGet(req, '/api/v2/admin/security/logins');
    ...
    router.get(
      ...
      async (req, res, next) => {
        try {
          const data: any = await apiGet(
            req,
            '/api/v2/admin/security/passwords',
          );
    ...
    router.get(
      ...
      async (req, res, next) => {
        try {
          const data: any = await apiGet(
            req,
            '/api/v2/admin/security/registration',
          );
